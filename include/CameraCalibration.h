...
public:
	...
	void on_combo_box_color_select(Gtk::ComboBox*) override;
	void on_combo_box_color_team1(Gtk::ComboBox*) override;
	void on_combo_box_color_team2(Gtk::ComboBox*) override;
	void on_combo_box_color_robot1(Gtk::ComboBox*) override;
	void on_combo_box_color_robot2(Gtk::ComboBox*) override;
	void on_combo_box_color_robot3(Gtk::ComboBox*) override;
	void on_combo_box_input_path(Gtk::ComboBox*) override;
