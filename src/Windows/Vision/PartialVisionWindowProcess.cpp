...
/*
                std::cout << "ALL: " << toDescription(objectName) << " : ";
                for (unsigned int m = 0; m < colorRecognizer->getRectangles().size(); m++ )
                    std::cout << colorRecognizer->getRectangles()[m];
                std::cout << std::endl;
*/
            }
        }
...
/*
                std::cout << "CUT: " << toDescription(objectName) << " : ";
                for (unsigned int m = 0; m < colorRecognizer->getRectangles().size(); m++ )
                    std::cout << colorRecognizer->getRectangles()[m];
                std::cout << std::endl;
*/
