...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Vision_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 27, 7)
    ...
    "Vision\0finished\0\0error\0err\0process\0"
};
...
void Vision::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Vision::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (Vision::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Vision::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Vision::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Vision.data,
      qt_meta_data_Vision,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Vision.stringdata))
...
// SIGNAL 0
void Vision::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Vision::error(QString _t1)
{
